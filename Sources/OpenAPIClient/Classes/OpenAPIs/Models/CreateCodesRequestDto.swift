...
public final class CreateCodesRequestDto: Codable, JSONEncodable, Hashable {
    ...
    public static func == (lhs: CreateCodesRequestDto, rhs: CreateCodesRequestDto) -> Bool {
